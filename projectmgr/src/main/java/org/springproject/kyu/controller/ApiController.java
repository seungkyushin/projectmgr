...
public class ApiController {
	...
	public Map<String, Object> getCommentList(@ModelAttribute CommentPageDto commentPage,
			@ModelAttribute SearchDto search,
			HttpServletResponse resonse,
			@CookieValue("searchType") String searchType,
			@CookieValue("keyword") String keyword
			) throws Exception{
		...
		if( searchType == null && keyword ==null ) {
			...
			if( search.getType().equals("none") == false 
